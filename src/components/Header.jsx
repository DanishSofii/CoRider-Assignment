    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        //   console.log("fjaesf",resultData);
          ...
          console.log(error);
          const collection = localStorage.getItem("messageData");
          const newData = JSON.parse(collection);
          setData(newData);
    ...
    return (
        ...
        <Container p="20px 16px 16px 16px" borderBottom="1px solid #E5E5E0" position="fixed" zIndex={10} bg="#FAF9F4" width="100%">
            <Flex alignItems="center" p="0px" mb="16px" flex={10} pr="40px" >
                ...
                {data && (<Text fontFamily="mulish" fontWeight={700} lineHeight="30.12px" color="#141E0D" w="275px" h="30px" fontSize="24px" textAlign="left" >{name}</Text>)}
                <Spacer/>
            ...
            <Flex justifyContent="space-between" alignItems="center"  pr="45px" >
                <Container  w="48px" h="48px" border="1px solid #fff" mr="16px" display="flex"  flexDirection="row" borderRadius="50%" overflow="hidden" >
                        ...
                        <img style={{height:"26px",width:"26px" ,position:"relative", top:"-4px"}}  src="/img/av2.jpeg" alt="" />
                        </div>
                        <div>
                        <img style={{height:"26px",width:"26px",position:"relative", right:"2px"}}  src="/img/av4.jpeg" alt="" />
                ...
                <Flex w="215px" h="46px" flexDirection="column" alignItems="start">
                    ...
                    {data && (<Text fontFamily="mulish" textAlign="left" fontWeight={700} lineHeight="22.59px">{from}</Text>)}
                    </Flex>
                    <Flex>
                    <Text fontFamily="mulish" textAlign="left" fontWeight={500} lineHeight="22.59px" mr="10px">To</Text>
                    {data && (<Text fontFamily="mulish" textAlign="left" fontWeight={700} lineHeight="22.59px">{to}</Text>)}
                    </Flex>
                </Flex>
                <Spacer/>
